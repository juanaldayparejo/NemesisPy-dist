...
class Atmosphere_0:
    """
    Class to define the atmospheric profiles
    """
    def __init__(self, runname='', NP=10, NVMR=6, ID=[0,0,0,0,0,0],
                ISO=[0,0,0,0,0,0], LATITUDE=0.0, LONGITUDE=0.0, NLOCATIONS=1, IPLANET=1, AMFORM=1, RADIUS=0.0):
        """
